...
urlpatterns = [
    ...
    path('drivers/update/<int:driver_id>/', update_driver, name='update_driver'),
    ...
    path('reset/<str:username>/<str:token>/', PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
]
