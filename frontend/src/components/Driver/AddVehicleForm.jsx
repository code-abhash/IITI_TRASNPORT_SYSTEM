...
//   const [drivers, setDrivers] = useState([]); // Store fetched drivers

//   // Fetch drivers from backend
//   useEffect(() => {
//     const fetchDrivers = async () => {
//       try {
//         const response = await fetch('http://127.0.0.1:8000/api/drivers/'); // Endpoint for fetching drivers
...
//     e.preventDefault();
//     try {
//       const response = await fetch('http://127.0.0.1:8000/api/add_vehicle/', {
//         method: 'POST',
//         headers: {
